...
TOOLSPATH = arduino-1.8.13/hardware/tools

# path location for Teensy 3 core
COREPATH = arduino-1.8.13/hardware/teensy/avr/cores/teensy3
...
COMPILERPATH = arduino-1.8.13/hardware/tools/arm/bin
...
CPPFLAGS = -mthumb -ffunction-sections -fdata-sections -nostdlib -MMD $(OPTIONS) -DTEENSYDUINO=144 -DF_CPU=$(TEENSY_CORE_SPEED) -I$(SRCPATH) -I$(COREPATH)
# warnings
